...
////////////////////////////////////////////////////////////////////////
// 생성자, 소멸자
CFlyingObject::CFlyingObject() : CCollisionObject()
{
...
void CFlyingObject::SetFlyingObjectsType(FlyingObjectType type)
{
	...
	else if (type == FlyingObjectType::Player_Arrow)
	{
		...
		m_EffectTriger = true;
		m_SoundTrigier = true;
		m_maxDistance = CONVERT_PaperUnit_to_InG(52);
	...
	else if (type == FlyingObjectType::Player_MagicSkill_Q)
	{
		...
		m_distance = 0.0f;
		m_maxDistance = CONVERT_PaperUnit_to_InG(46.8f);
	...
	else if (type == FlyingObjectType::Player_ArrowSkill_Q)
	{
		...
		m_distance = 0.0f;
		m_SoundTrigier = true;
		m_maxDistance = CONVERT_PaperUnit_to_InG(41.6f);
	...
	else if (type == FlyingObjectType::Player_ArrowSkill_W)
	{
		...
		m_distance = 0.0f;
		m_SoundTrigier = true;
		m_maxDistance = CONVERT_PaperUnit_to_InG(65);
	...
	else if (type == FlyingObjectType::Player_ArrowSkill_E)
	{
		...
		m_distance = 0.0f;
		m_EffectTriger = true;
		m_maxDistance = CONVERT_PaperUnit_to_InG(104);
