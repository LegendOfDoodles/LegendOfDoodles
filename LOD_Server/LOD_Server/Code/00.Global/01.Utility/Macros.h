...
#define TETRRAIN_COLLISION_WIDTH 2000.0f
#define TETRRAIN_COLLISION_HEIGHT 1000.0f
...
// 플레이어 무기별 증가량-----------
// 체력
#define INCREASE_SWORD_PLAYER_HP 47
#define INCREASE_STAFF_PLAYER_HP 33
#define INCREASE_BOW_PLAYER_HP 26
#define INCREASE_STICK_PLAYER_HP INCREASE_STAFF_PLAYER_HP

// 체력 보정 값
#define ADJUST_SWORD_PLAYER_HP(adjLevel) 116 + adjLevel * (INCREASE_SWORD_PLAYER_HP - INCREASE_STICK_PLAYER_HP)
#define ADJUST_STAFF_PLAYER_HP(adjLevel) 47 + adjLevel * (INCREASE_STAFF_PLAYER_HP - INCREASE_STICK_PLAYER_HP)
#define ADJUST_BOW_PLAYER_HP(adjLevel) 15 + adjLevel * (INCREASE_BOW_PLAYER_HP - INCREASE_STICK_PLAYER_HP)

// 공격력
#define INCREASE_SWORD_PLAYER_ATK 31.6f
#define INCREASE_STAFF_PLAYER_ATK 27.8f
#define INCREASE_BOW_PLAYER_ATK 23.4f
#define INCREASE_STICK_PLAYER_ATK INCREASE_SWORD_PLAYER_ATK

// 공격력 보정 값
#define ADJUST_SWORD_PLAYER_ATK(adjLevel) 4 + adjLevel * (INCREASE_SWORD_PLAYER_ATK - INCREASE_STICK_PLAYER_ATK)
#define ADJUST_STAFF_PLAYER_ATK(adjLevel) 11 + adjLevel * (INCREASE_STAFF_PLAYER_ATK - INCREASE_STICK_PLAYER_ATK)
#define ADJUST_BOW_PLAYER_ATK(adjLevel) 8 + adjLevel * (INCREASE_BOW_PLAYER_ATK - INCREASE_STICK_PLAYER_ATK)

// 방어력
#define INCREASE_SWORD_PLAYER_DEF 2.8f
#define INCREASE_STAFF_PLAYER_DEF 1.f
#define INCREASE_BOW_PLAYER_DEF 1.2f
#define INCREASE_STICK_PLAYER_DEF INCREASE_STAFF_PLAYER_DEF

// 방어력 보정 값
#define ADJUST_SWORD_PLAYER_DEF(adjLevel) 16 + adjLevel * (INCREASE_SWORD_PLAYER_DEF - INCREASE_STICK_PLAYER_DEF)
#define ADJUST_STAFF_PLAYER_DEF(adjLevel) 5 + adjLevel * (INCREASE_STAFF_PLAYER_DEF - INCREASE_STICK_PLAYER_DEF)
#define ADJUST_BOW_PLAYER_DEF(adjLevel) 11 + adjLevel * (INCREASE_BOW_PLAYER_DEF - INCREASE_STICK_PLAYER_DEF)

// 스킬
#define INCREASE_SWORD_PLAYER_SKILL_Q 1.13f
#define INCREASE_SWORD_PLAYER_SKILL_W 1.27f
#define INCREASE_SWORD_PLAYER_SKILL_E 1.42f
#define INCREASE_SWORD_PLAYER_SKILL_R 2.3f

#define INCREASE_STAFF_PLAYER_SKILL_Q 1.02f
#define INCREASE_STAFF_PLAYER_SKILL_W 1.15f
#define INCREASE_STAFF_PLAYER_SKILL_E 1.29f
#define INCREASE_STAFF_PLAYER_SKILL_R 1.64f

#define INCREASE_BOW_PLAYER_SKILL_Q 1.12f
#define INCREASE_BOW_PLAYER_SKILL_W 0.9f
#define INCREASE_BOW_PLAYER_SKILL_E 0.82f
#define INCREASE_BOW_PLAYER_SKILL_R 2.3f

// 미니언 무기별 스테이터스 증가량
// 체력
#define INCREASE_SWORD_MINION_HP 10
#define INCREASE_STAFF_MINION_HP 6
#define INCREASE_BOW_MINION_HP 4
// 공격력
#define INCREASE_SWORD_MINION_ATK 0.2f
#define INCREASE_STAFF_MINION_ATK 0.4f
#define INCREASE_BOW_MINION_ATK 0.7f
// 방어력
#define INCREASE_SWORD_MINION_DEF 4
#define INCREASE_STAFF_MINION_DEF 1
#define INCREASE_BOW_MINION_DEF 2

// 정글몬스터 스테이터스 증가량
// 체력
#define INCREASE_COMMON_ROIDER_BF_HP 35
#define INCREASE_COMMON_ROIDER_AF_HP 56
#define INCREASE_COMMON_GOLEM_BF_HP 62
#define INCREASE_COMMON_GOLEM_AF_HP 96
// 공격력
#define INCREASE_COMMON_ROIDER_BF_ATK 1
#define INCREASE_COMMON_ROIDER_AF_ATK 3
#define INCREASE_COMMON_GOLEM_BF_ATK 8
#define INCREASE_COMMON_GOLEM_AF_ATK 14
// 방어력
#define INCREASE_COMMON_ROIDER_BF_DEF 1
#define INCREASE_COMMON_ROIDER_AF_DEF 2
#define INCREASE_COMMON_GOLEM_BF_DEF 2
#define INCREASE_COMMON_GOLEM_AF_DEF 3
...
// 몬스터 관련
#define DELAY_BETWEEN_SPAWN_MINION 0.42f
#define TIME_SPAWN_FIRST_MINION 40.0f
