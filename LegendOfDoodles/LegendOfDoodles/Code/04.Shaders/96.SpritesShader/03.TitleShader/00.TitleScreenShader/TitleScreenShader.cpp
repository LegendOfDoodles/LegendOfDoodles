...
////////////////////////////////////////////////////////////////////////
// 생성자, 소멸자
CTitleScreenShader::CTitleScreenShader(shared_ptr<CCreateMgr> pCreateMgr) : CShader(pCreateMgr)
{
}
...
////////////////////////////////////////////////////////////////////////
// 공개 함수
void CTitleScreenShader::ReleaseUploadBuffers()
{
...
void CTitleScreenShader::UpdateShaderVariables(int opt)
{
...
void CTitleScreenShader::Render(CCamera * pCamera)
{
...
////////////////////////////////////////////////////////////////////////
// 내부 함수
D3D12_INPUT_LAYOUT_DESC CTitleScreenShader::CreateInputLayout()
{
...
D3D12_RASTERIZER_DESC CTitleScreenShader::CreateRasterizerState()
{
...
D3D12_SHADER_BYTECODE CTitleScreenShader::CreateVertexShader(ComPtr<ID3DBlob>& pShaderBlob)
{
...
D3D12_SHADER_BYTECODE CTitleScreenShader::CreatePixelShader(ComPtr<ID3DBlob>& pShaderBlob)
{
	return(CShader::CompileShaderFromFile(
		L"./code/04.Shaders/99.GraphicsShader/SpriteShader.hlsl",
		"PSTextured",
...
void CTitleScreenShader::CreateShader(shared_ptr<CCreateMgr> pCreateMgr, UINT nRenderTargets, bool isRenderBB, bool isRenderShadow)
{
	m_nPipelineStates = 1;
...
void CTitleScreenShader::BuildObjects(shared_ptr<CCreateMgr> pCreateMgr, void * pContext)
{
	...
	m_ppMaterials[0] = Materials::CreateTitleScreenMaterial(pCreateMgr, &m_psrvCPUDescriptorStartHandle[0], &m_psrvGPUDescriptorStartHandle[0]);
...
void CTitleScreenShader::ReleaseObjects()
{
