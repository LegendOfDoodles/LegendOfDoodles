...
////////////////////////////////////////////////////////////////////////
// 생성자, 소멸자
CRoomScreenShader::CRoomScreenShader(shared_ptr<CCreateMgr> pCreateMgr) : CShader(pCreateMgr)
{
}

CRoomScreenShader::~CRoomScreenShader()
{
}

////////////////////////////////////////////////////////////////////////
// 공개 함수
void CRoomScreenShader::ReleaseUploadBuffers()
{
...
void CRoomScreenShader::UpdateShaderVariables(int opt)
{
...
void CRoomScreenShader::Render(CCamera * pCamera)
{
...
////////////////////////////////////////////////////////////////////////
// 내부 함수
D3D12_INPUT_LAYOUT_DESC CRoomScreenShader::CreateInputLayout()
{
...
D3D12_RASTERIZER_DESC CRoomScreenShader::CreateRasterizerState()
{
...
D3D12_SHADER_BYTECODE CRoomScreenShader::CreateVertexShader(ComPtr<ID3DBlob>& pShaderBlob)
{
...
D3D12_SHADER_BYTECODE CRoomScreenShader::CreatePixelShader(ComPtr<ID3DBlob>& pShaderBlob)
{
	return(CShader::CompileShaderFromFile(
		L"./code/04.Shaders/99.GraphicsShader/SpriteShader.hlsl",
		"PSTextured",
...
void CRoomScreenShader::CreateShader(shared_ptr<CCreateMgr> pCreateMgr, UINT nRenderTargets, bool isRenderBB, bool isRenderShadow)
{
	m_nPipelineStates = 1;
...
void CRoomScreenShader::BuildObjects(shared_ptr<CCreateMgr> pCreateMgr, void * pContext)
{
	...
	m_ppMaterials[0] = Materials::CreateRoomScreenMaterial(pCreateMgr, &m_psrvCPUDescriptorStartHandle[0], &m_psrvGPUDescriptorStartHandle[0]);
...
void CRoomScreenShader::ReleaseObjects()
{
